...
START_TEST(s21_is_equal_19) {  // отрицательные отличаются 3
...
START_TEST(s21_is_equal_20) {  // отрицательные числа (отличаются 3
                               ////разряды, большая степень)
  s21_decimal src1, src2;
  int origin;
...
START_TEST(s21_is_equal_21) {  // отрицательные отличаются 3
                               ////разряды, большая степень)
  s21_decimal src1, src2;
  int origin;
  src1.bits[0] = 0b11111111111111111111111111111111;
...
Suite *test_s21_is_equal(void) {
  ...
  tcase_add_test(tc, s21_is_equal_21);
  tcase_add_test(tc, s21_is_equal_22);
