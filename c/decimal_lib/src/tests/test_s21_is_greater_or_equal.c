...
START_TEST(s21_is_greater_or_equal_2) {  // первое число отрицательное
  s21_decimal src1, src2;
  int origin;
  src1.bits[0] = 0b00000000000000000000000000001110;
  src1.bits[1] = 0b00000000000000000000000000000000;
...
START_TEST(
    s21_is_greater_or_equal_4) {  // отрицательные числа (отличаются 2 разряды)
  s21_decimal src1, src2;
  int origin;
  src1.bits[0] = 0b00000000000000000000000000001110;
...
START_TEST(
    s21_is_greater_or_equal_6) {  // положительные числа (оличаются 0 разряды)
  s21_decimal src1, src2;
  int origin;
...
START_TEST(s21_is_greater_or_equal_8) {  // положительные числа (равны)
  s21_decimal src1, src2;
  int origin;
  src1.bits[0] = 0b00000000000000000000000000000001;
  src1.bits[1] = 0b00000000000000000000000000010111;
...
START_TEST(
    s21_is_greater_or_equal_11) {  // отрицательные числа (отличаются 3 разряды)
  s21_decimal src1, src2;
  int origin;
...
START_TEST(
    s21_is_greater_or_equal_12) {  // отрицательные числа (отличаются 1 разряды)
  s21_decimal src1, src2;
  int origin;
...
START_TEST(
    s21_is_greater_or_equal_13) {  // отрицательные числа (отличаются 3 разряды)
  s21_decimal src1, src2;
  int origin;
...
START_TEST(s21_is_greater_or_equal_19) {  // отрицательные отличаются 3
...
START_TEST(s21_is_greater_or_equal_20) {  // отрицательные числа (отличаются 3
  ////разряды, большая степень)
  s21_decimal src1, src2;
  int origin;
  src1.bits[0] = 0b00000000000000000000000000101110;
...
START_TEST(s21_is_greater_or_equal_21) {  // отрицательные отличаются 3
  ////разряды, большая степень)
  s21_decimal src1, src2;
  int origin;
  src1.bits[0] = 0b11111111111111111111111111111111;
