...
В проекте реализована библиотека для работы с матрицами, используя объектно-ориентированный подход. Было использовано правило пяти (деструктор, копи- и мув- констуркторы). Написаны основные операции над матрицами и выполнена перегрузка операторов, соответсвующих операцияй.
